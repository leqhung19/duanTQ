        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description_vi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    AudioContent_vi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AudioContent_en = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AudioContent_cn = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListenLogs_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QRCodes_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListenLogs_RestaurantId",
                table: "ListenLogs",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_QRCodes_RestaurantId",
                table: "QRCodes",
                column: "RestaurantId");
